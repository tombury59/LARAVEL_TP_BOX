                ...
                @endif
                    ...
                    @if (session('error'))
                        <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                            <span class="font-medium">Erreur!</span> Vous ne pouvez pas accéder à cette boxe!
                        </div>
                    @endif
                            ...
                            <div class="rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg
                                ...
                                <div class="p-6">
                                    <div class="flex flex-row justify-between ">
                                        ...
                                        <a href="{{ route('boxes.show', $boxe->box_id) }}" class="px-4 py-2 bg-indigo-100 text-white rounded-md hover:bg-indigo-700 transition-colors duration-300">
